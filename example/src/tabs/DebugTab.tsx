    ...
    return (
        <View style={s.container}>
            ...
            <View style={s.toolbar}>
                <TouchableOpacity style={s.toolbarBtn} onPress={load} disabled={loading}>
                    <Text style={[s.toolbarBtnText, loading && s.disabled]}>
                        {loading ? 'Loading…' : 'Refresh'}
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity style={s.toolbarBtn} onPress={copyState} disabled={!state}>
                    <Text style={[s.toolbarBtnText, !state && s.disabled]}>Copy</Text>
                </TouchableOpacity>
                <TouchableOpacity style={s.toolbarBtn} onPress={shareState} disabled={!state}>
